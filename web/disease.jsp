...
<form name="frm" method="post" action="Display_Records/GetRecords">    
...
<td width="88%" valign="top" bgcolor="#FFFFFF">
    <font size="4" color=#F88017>Search By Disease Name</font>
<HR NOSHADE>
<br>
<b> Enter a Disease Name </b> 
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input type="text" name="disease" size ="30" /> <input type="submit" value="Search" /> 
</td></tr>
</table>  
</form>
</body>
